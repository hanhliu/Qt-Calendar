from PySide6.QtGui import QPalette, Qt, QFont, QIcon
from PySide6.QtWidgets import QWidget, QMainWindow, QLabel, QPushButton, QApplication, QGridLayout, QMenuBar, \
    QToolButton, QHBoxLayout, QSizePolicy
from pyqt_frameless_window.framelessWindow import FramelessWindow

from src.custom_title.mac_buttons_widget import MacButtonsWidget
from src.custom_title.svg_label import SvgLabel
from src.custom_title.top_titlebar_widget import TopTitleBarWidget
from src.custom_title.window_button_widget import WindowsButtonsWidget


class CustomTitlebarWindoww(FramelessWindow):
