from PySide6.QtGui import QFont, Qt, qGray, QColor, QPalette
from PySide6.QtWidgets import QWidget, QLabel, QFrame, QGridLayout

from src.custom_title.svg_icon_text_widget import SvgIconTextWidget
