...
from NodeGraphOriginal.NodeGraphQt import (
    NodeGraph,
    PropertiesBinWidget,
    NodesTreeWidget,
    NodesPaletteWidget
...
from NodeGraphOriginal.nodes import custom_ports_node, group_node, widget_nodes, basic_nodes
...
if __name__ == '__main__':
    ...
    properties_bin.setWindowFlags(Qt.Tool)
